...
const ChatBubbleOne = ({ message, previousMessageSenderId }: { message: Message, previousMessageSenderId: number | null }) => {
  return (
    <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center', maxWidth: 260, minWidth: 50 }}>
        ...
        <View style={{ backgroundColor: lightGray, padding: 10, borderRadius: 10, marginLeft: message.sender_id !== previousMessageSenderId ? 0 : 48, minWidth: 60 }}>
